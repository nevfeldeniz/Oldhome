import { Facebook, Instagram, Mail, MapPin, MessageCircle, Phone, TreePine } from 'lucide-react'
          ...
          <div>
            ...
            <div className="mt-5 flex gap-3">
              <a
                ...
                className="grid h-10 w-10 place-items-center rounded-full border border-cream/20 bg-cream/5 text-cream transition-colors hover:bg-cream/15"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="WhatsApp"
                className="grid h-10 w-10 place-items-center rounded-full border border-cream/20 bg-[#25D366]/20 text-cream transition-colors hover:bg-[#25D366]/35"
              >
