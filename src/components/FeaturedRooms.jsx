...
export default function FeaturedRooms() {
  ...
  return (
    <section id="rooms" className="bg-cream py-16 sm:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-8">
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {featured.map((room, index) => (
            <article
              key={room.id}
              className="flex flex-col overflow-hidden rounded-2xl border border-wine/10 bg-parchment shadow-sm"
            >
              ...
              <div className="flex flex-1 flex-col p-5 sm:p-6">
                ...
                <p className="mt-2 flex-1 text-sm leading-relaxed text-ink/75 line-clamp-2">
