...
export const defaultSiteData = {
  ...
  showcaseRooms: [
    ...
    { id: 6, number: 'Oda 006', type: '3 Kişilik', description: 'Tek kişilik ve çift kişilik yatak düzeniyle üç kişilik gruplar için ideal ferah odamız. Pencere kenarı oturma köşesi, Smart TV, mini buzdolabı ve mermer kaplı özel banyosuyla konforlu bir konaklama sunar.', price: '2.700 TL', oldPrice: '3.500 TL', images: ['rooms/006/01.png', 'rooms/006/02.png', 'rooms/006/03.png', 'rooms/006/04.png'], features: ['Ücretsiz Wi-Fi', 'Klima', 'Geniş Aile Yatağı', 'Çay & Kahve İkramı', 'Smart TV', 'Özel Banyo', 'Mini Buzdolabı', 'Günlük Temizlik'] },
    ...
    { id: 8, number: 'Oda 008', type: '3 Kişilik', description: 'Mermer zeminli, modern üç kişilik odamız. Tek kişilik ve çift kişilik yatak düzeni, hasır oturma köşesi, Smart TV, mini buzdolabı ve mermer kaplı özel banyosuyla aileler ve gruplar için idealdir.', price: '2.700 TL', oldPrice: '3.500 TL', images: ['rooms/008/01.png', 'rooms/008/02.png', 'rooms/008/03.png', 'rooms/008/04.png'], features: ['Ücretsiz Wi-Fi', 'Klima', 'Geniş Aile Yatağı', 'Çay & Kahve İkramı', 'Smart TV', 'Özel Banyo', 'Mini Buzdolabı', 'Günlük Temizlik'] },
    ...
    { id: 11, number: 'Oda 011', type: '3 Kişilik', description: 'Üst katın köşesinde yer alan, bol ışıklı ve geniş üç kişilik odamız. Kalabalık aileler için uygun.', price: '2.700 TL', oldPrice: '3.500 TL', images: ['room-3.png', 'room.png', 'bathroom.png', 'hero-building.png'], features: ['Ücretsiz Wi-Fi', 'Klima', 'Geniş Aile Yatağı', 'Çay & Kahve İkramı', 'Smart TV', 'Özel Banyo', 'Mini Buzdolabı', 'Günlük Temizlik'] },
  ],
