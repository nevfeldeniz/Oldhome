...
export const defaultSiteData = {
  ...
  showcaseRooms: [
    { id: 1, number: 'Oda 001', type: 'Çift', description: 'Zemin katta, ferah ve aydınlık çift kişilik odamız. Sıcak ahşap tonları ve konforlu yatağıyla huzurlu bir konaklama sunar.', price: '2.700 TL', images: ['room-2.png', 'room.png', 'bathroom.png', 'hero-building.png'], features: ['Ücretsiz Wi-Fi', 'Klima', 'Çift Kişilik Yatak', 'Çay & Kahve İkramı', 'Smart TV', 'Özel Banyo', 'Saç Kurutma Makinesi', 'Günlük Temizlik'] },
